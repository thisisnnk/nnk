export const projects = [
  {
    ...
    mockup: '/screenshots/ah-crm/dashboard.jpg',
    ...
    metrics: [
      { label: 'Lead loss rate',   value: '↓ 88', suffix: '%'    },
      { label: 'Follow-up rate',   value: '+42',  suffix: ' pts' },
      { label: 'Daily admin time', value: '↓ 73', suffix: '%'    },
    ],
  ...
  },
  {
    ...
    mockup: '/screenshots/ah-itinerary/dashboard.jpg',
    ...
    metrics: [
      { label: 'Creation time', value: '45 min', suffix: ' → 12 min' },
      { label: 'Day-plan reuse', value: '0%', suffix: ' → 80%' },
...
export const testimonials = [
  {
    id: 1,
    name: 'Thangavadivoo',
    role: 'Managing Director, PVT Engineering',
    company: 'PVT Engineering',
    text: "Operational clarity improved significantly — order processing became 60% faster, and pricing errors reduced by 45%. With over 3,500+ hours optimized annually, the structured systems implemented in collaboration with NNK strengthened both efficiency and compliance.",
    rating: 5,
  },
  {
    id: 2,
    name: 'Kishore Ravi',
    role: 'Founder & CEO, Adventure Holidays',
    company: 'Adventure Holidays',
    text: "Speed and consistency were critical for us. Itinerary creation became 65% faster, content rework reduced by 50%, and consultant productivity improved by 40%. The workflow automation delivered by NNK has elevated how Adventure Holidays serves clients.",
    rating: 5,
  },
  {
    id: 3,
    name: 'Karuppasamy',
    role: 'Founder & CEO, PVT Engineering',
    company: 'PVT Engineering',
    text: "Our finance operations saw a major shift after implementing systems developed by NNK. GST reconciliation time reduced by 65%, errors dropped by 40%, and quotation processing improved by 70%. With 100% financial data accessibility, decision-making is now faster and more reliable.",
    rating: 5,
  },
  {
    id: 4,
    name: 'Thilipan',
    role: 'Manager, Thilipan Constructions',
    company: 'Thilipan Constructions',
    text: "Invoice preparation time reduced by 60%, and billing errors dropped by 45% after implementing the system from NNK. With centralized financial records, our documentation is now accurate, compliant, and far more efficient.",
    rating: 5,
  },
  {
    id: 5,
    name: 'Vimal',
    role: 'Administrator, Adventure Holidays',
    company: 'Adventure Holidays',
    text: "From a coordination perspective, communication is now structured and transparent. Productivity improved by 40%, with 100% organized record storage. Working closely with NNK, we've reduced follow-up confusion and improved internal response efficiency.",
    rating: 5,
  },
  {
    id: 6,
    ...
    role: 'Founder, KINT',
    company: 'KINT',
    text: "Scaling a SaaS platform means our own operations have to be as tight as the product we ship. NNK helped us cut customer onboarding time by 55%, reduce manual provisioning errors by 50%, and improve release cycle speed by 40%. With 100% process visibility across the team, we move faster and stay audit-ready at every stage.",
    rating: 5,
  },
]
